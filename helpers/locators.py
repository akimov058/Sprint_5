...
class Locators:
    ...
    BUTTON_LOGIN_IN_PAGE_LOGIN = (By.XPATH,"//button[@class='button_button__33qZ0 button_button_type_primary__1O7Bx button_button_size_medium__3zxIa']") #Кнопка войти на странице входа
    BUTTON_PERSONAL_ACCOUNT = (By.XPATH,"(//p[@class='AppHeader_header__linkText__3q_va ml-2'])[3]") #Кнопка личный кабинет
    BUTTON_LOGIN_IN_PAGE_REGISTRATION = (By.XPATH,"(//a[@class='Auth_link__1fOlj'])") #Кнопка войти на странице регистрации